...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Saifan-iOS/MyLib.git'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Saifan Nadaf' => 'saifan1.nadaf@paytm.com' }
  s.source           = { :git => 'https://github.com/Saifan-iOS/MyLib.git', :tag => s.version.to_s }
